...
public class DataTypeExample : MonoBehaviour
{
    void Start()
    {
        ...
        short money0 = 32767;           // 2바이트
        //int   money1 = 12000000000;     // 4바이트 // int가 표현할 수 있는 데이터의 범위는 -2,147,483,648 ~ 2,147,483,647
        long  money2 = 12000000000;     // 8바이트 // long이 표현할 수 있는 데이터의 범위는 -9,223,372,036,854,775,808 ~ 9,223,372,036,854,775,807

        // - (예) mmorpg 게임에 데이터 종류는  50만 가지
        int  id  = 204023;
        ...
        long money11 = 238472893748923;
        int  money22 = (int)money11;   // 내가 강제로 명확하게! 데이터의 자료형을 바꾸겠다 -> 명시적 형변환
